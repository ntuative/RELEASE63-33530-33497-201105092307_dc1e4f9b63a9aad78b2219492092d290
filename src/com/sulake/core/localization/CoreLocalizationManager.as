package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         return this.var_989[param1] as ILocalizationDefinition;
      }
      
      public function getActiveLocalizationDefinition() : ILocalizationDefinition
      {
         return this.getLocalizationDefinition(this.var_2631);
      }
      ...
      public function loadLocalizationFromURL(param1:String) : void
      {
         ...
         _loc4_.addEventListener(AssetLoaderEvent.const_49,this.onLocalizationFailed);
      }
      ...
      private function onLocalizationReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.events.dispatchEvent(new Event(LocalizationEvent.const_178));
         }
      }
      ...
      {
         var _loc3_:Localization = this.var_57[param1] as Localization;
         if(_loc3_ == null)
         {
            this.var_1214.push(param1);
            return param2;
         }
         return _loc3_.value;
      }
      ...
      {
         var _loc3_:Localization = this.var_57[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Localization(param1,param2);
            this.var_57[param1] = _loc3_;
         }
         else
         {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_1896);
         }
      }
      ...
      {
         var _loc5_:Localization = this.var_57[param1];
         if(_loc5_ == null)
         {
            _loc5_ = new Localization(param1);
            this.var_57[param1] = _loc5_;
         }
      ...
      {
         return this.var_57[param1] as ILocalization;
      }
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this.var_57)
         {
            ...
            {
               _loc2_.registerParameter("predefined",this.var_1896);
            }
         }
      }
   }
