package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1532:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1533:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_165:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_2948 = new Array();
         this.var_165 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1532() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_165)
         {
            this.var_165.removeStopEventListener(this.refresh);
            this.var_165 = null;
         }
         if(!this.var_165 && param1)
         {
            this.var_165 = param1;
            this.var_165.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_481)
            {
               this.var_1970 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_165.getProfilerAgentsInArray();
         ...
         if(this.var_1970)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_165.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_165.numBitmapAssetInstances + " / " + this.var_165.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_165.numTrackedBitmapDataInstances + " / " + this.var_165.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1533() as ByteArray;
