package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1334:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_857:Number;
      
      protected var var_566:Number;
      ...
      protected var var_127:Boolean = false;
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_196);
         }
      ...
      {
         this.var_857 = param1;
         this._field.scrollH = this.var_857 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_857 * this.maxScrollH,this.var_566 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_926,this._field.antiAliasType,PropertyStruct.const_54,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1330));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1093 ? new PropertyStruct(PropertyDefaults.const_772,this._autoSize,PropertyStruct.const_54,true,PropertyDefaults.const_1151) : PropertyDefaults.const_1688);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_39,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_159,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_face",this.defaultTextFormat.font,PropertyStruct.const_54,this.defaultTextFormat.font != _loc2_.fontFamily));
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1108 ? new PropertyStruct(PropertyDefaults.const_1150,this._field.gridFitType,PropertyStruct.const_54,true,PropertyDefaults.const_1300) : PropertyDefaults.const_1602);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_851) ? new PropertyStruct(PropertyDefaults.const_443,this._field.textColor,PropertyStruct.const_159,true) : PropertyDefaults.const_1290);
         _loc1_.push(this.var_408 != TextStyleManager.const_196 ? new PropertyStruct(PropertyDefaults.const_433,this.var_408,PropertyStruct.const_54,true,PropertyDefaults.const_796) : PropertyDefaults.const_1187);
         _loc1_.push(this.var_40.left != PropertyDefaults.const_884 ? new PropertyStruct(PropertyDefaults.const_253,this.var_40.left,PropertyStruct.const_43,true) : PropertyDefaults.const_641);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_803 ? new PropertyStruct(PropertyDefaults.const_277,this.var_40.top,PropertyStruct.const_43,true) : PropertyDefaults.const_511);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_837 ? new PropertyStruct(PropertyDefaults.const_276,this.var_40.right,PropertyStruct.const_43,true) : PropertyDefaults.const_531);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_845 ? new PropertyStruct(PropertyDefaults.const_261,this.var_40.bottom,PropertyStruct.const_43,true) : PropertyDefaults.const_635);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1097 ? new PropertyStruct(PropertyDefaults.const_793,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1653);
         ...
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_54,this._field.restrict != null));
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_134,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_134,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_134,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
