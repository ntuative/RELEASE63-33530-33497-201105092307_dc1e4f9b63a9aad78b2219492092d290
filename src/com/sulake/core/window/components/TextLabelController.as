package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2547 = _loc2_.textWidth;
         this.var_2546 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_365 != _loc2_.color : this.var_365 != null && this.var_365 != PropertyDefaults.const_851) ? new PropertyStruct(PropertyDefaults.const_443,this.var_365,PropertyStruct.const_159,true) : PropertyDefaults.const_1290);
         if(this.var_40)
         {
            if(this.var_40.left != PropertyDefaults.const_884)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_253,this.var_40.left,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_641);
            }
            if(this.var_40.top != PropertyDefaults.const_803)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_277,this.var_40.top,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_511);
            }
            if(this.var_40.right != PropertyDefaults.const_837)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_276,this.var_40.right,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_531);
            }
            if(this.var_40.bottom != PropertyDefaults.const_845)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_261,this.var_40.bottom,PropertyStruct.const_43,true));
            }
            else
            {
