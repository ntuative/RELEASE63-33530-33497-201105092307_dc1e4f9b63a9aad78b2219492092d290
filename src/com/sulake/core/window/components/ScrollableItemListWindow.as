package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1173:IItemListWindow;
      
      private var var_433:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_86))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_433)
         {
            this.var_433.removeEventListener(WindowEvent.const_254,this.scrollBarEventProc);
            this.var_433.removeEventListener(WindowEvent.const_273,this.scrollBarEventProc);
            this.var_433 = null;
         }
         if(this.var_1173)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1173)
         {
            this.var_1173 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_433)
         {
            this.var_433 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_433)
            {
               this.var_433.addEventListener(WindowEvent.const_254,this.scrollBarEventProc);
               this.var_433.addEventListener(WindowEvent.const_273,this.scrollBarEventProc);
            }
         }
         return this.var_433;
      }
      ...
      {
         if(param1.type == WindowEvent.const_254)
         {
            this.showScrollBar();
         }
         else if(param1.type == WindowEvent.const_273)
         {
            this.hideScrollBar();
         }
      }
