package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1784:int = 4;
      ...
      {
         return this.var_417.length + this.var_282.length;
      }
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(this.var_282.length < const_1784 && this.var_417.length > 0)
            {
               _loc1_ = this.var_417.shift();
               this.var_282.push(_loc1_);
               _loc1_.resume();
            }
         }
      }
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         try
         {
            index = this.var_417.indexOf(loader);
            if(index > -1)
            {
               this.var_417.splice(index,1);
            }
            index = this.var_282.indexOf(loader);
            if(index > -1)
            {
               this.var_282.splice(index,1);
            }
         }
         catch(e:Error)
         {
