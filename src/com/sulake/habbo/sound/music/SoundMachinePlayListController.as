package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_217:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_217 = param2;
         this.var_735 = [];
         this.var_735.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_735.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_735)
         {
         ...
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_765,this.onSoundMachinePlayEvent);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_811,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_80)
            {
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_765,this.onSoundMachinePlayEvent);
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_811,this.onSoundMachineStopEvent);
               this.var_80 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_412);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_217.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_412 = -1;
         this.var_583 = false;
         this.var_217.stop(HabboMusicPrioritiesEnum.const_129);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_217.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_217.playSong(param1,HabboMusicPrioritiesEnum.const_129,_loc3_,0,0,0))
         {
