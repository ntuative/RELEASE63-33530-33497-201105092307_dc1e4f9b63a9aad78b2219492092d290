package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_674:String = "tab_boy";
      
      private const const_675:String = "tab_girl";
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_65,FigureData.FACE,_windowManager,_assetLibrary);
         }
         else
         {
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_65.controller.gender)
         {
            case FigureData.const_81:
               activateTab(this.const_674);
               inactivateTab(this.const_675);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_675);
               inactivateTab(this.const_674);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_674:
                  var_65.controller.gender = FigureData.const_81;
