package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_442:AvatarRenderManager;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_907:AvatarActionManager;
      
      private var var_346:FigureData;
      
      private var var_415:PartSetsData;
      
      private var _animationData:AnimationData;
      
      private var var_737:AnimationManager;
      
      private var var_964:ActionDefinition;
      
      private var var_500:String;
      
      private var var_1393:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         super();
         this.var_442 = param1;
         this.var_346 = new FigureData();
         this.var_415 = new PartSetsData();
         this._animationData = new AnimationData();
         this.var_737 = new AnimationManager();
         this.var_500 = param2;
      ...
      {
         this.var_1393.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_907 = new AvatarActionManager(param1,this.var_500,param2);
         this.var_964 = this.var_907.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         ...
         if(this.var_415.parse(param1))
         {
            if(this.var_500 == AvatarType.const_125)
            {
               this.var_415.getPartDefinition("ri").appendToFigure = true;
               this.var_415.getPartDefinition("li").appendToFigure = true;
            }
            return true;
         }
         return false;
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         ...
         return this.var_346.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_346.injectXML(param1);
      }
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_737.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      public function getPartColor(param1:IAvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_346.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_346.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return this.var_737.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_737.getAnimation(param1) as Animation;
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return this.var_907.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_907.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_907.sortActions(param1);
      }
      
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(!this.var_603[param1])
         {
            this.var_603[param1] = new Dictionary();
         }
         if(this.var_603[param1][param2])
         {
            return this.var_603[param1][param2];
         }
         this.var_603[param1][param2] = this.var_346.getMandatorySetTypeIds(param1,param2);
         return this.var_603[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_346.getDefaultPartSet(param1,param2);
      }
      
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         return this.var_907.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_737.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = this.var_415.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = this.var_415.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1788[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:Array = this.var_415.getActiveParts(param3.definition);
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc9_ = this.var_737.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_346.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_346.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
                  ...
                  if(_loc31_)
                  {
                     ...
                     for each(_loc32_ in _loc31_.parts)
                     {
                        if(_loc15_.indexOf(_loc32_.type) > -1)
                        {
                           ...
                           {
                              _loc33_ = this.var_964;
                           }
                           _loc12_ = this.var_415.getPartDefinition(_loc32_.type);
         ...
         for each(_loc11_ in _loc15_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc8_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc12_ = this.var_415.getPartDefinition(_loc11_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         return this.var_1393.getOffset(param1,param2,param3,param4,param5,param6);
      }
