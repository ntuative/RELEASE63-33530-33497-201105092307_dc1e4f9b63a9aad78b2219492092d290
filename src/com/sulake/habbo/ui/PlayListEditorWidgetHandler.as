package com.sulake.habbo.ui
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1418:IMessageEvent;
      
      private var var_1754:IMessageEvent;
      
      private var var_1755:IMessageEvent;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.soundManager)
         {
            ...
            this._container.soundManager.events.addEventListener(PlayListStatusEvent.const_107,this.processSoundManagerEvent);
            this._container.soundManager.events.addEventListener(PlayListStatusEvent.const_144,this.processSoundManagerEvent);
            this._container.soundManager.events.addEventListener(NowPlayingEvent.const_101,this.processSoundManagerEvent);
      ...
      {
         this.var_1418 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1754 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1755 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1418);
         this._connection.addMessageEvent(this.var_1754);
         this._connection.addMessageEvent(this.var_1755);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1418);
               this._connection.removeMessageEvent(this.var_1754);
               this._connection.removeMessageEvent(this.var_1755);
            }
            ...
            if(this._container)
            {
               if(this._container.soundManager)
               {
                  if(this._container.soundManager.events)
                  {
                     ...
                     this._container.soundManager.events.removeEventListener(PlayListStatusEvent.const_107,this.processSoundManagerEvent);
                     this._container.soundManager.events.removeEventListener(PlayListStatusEvent.const_144,this.processSoundManagerEvent);
                     this._container.soundManager.events.removeEventListener(NowPlayingEvent.const_101,this.processSoundManagerEvent);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_914,RoomWidgetPlayListModificationMessage.const_950,RoomWidgetPlayListModificationMessage.const_849,RoomWidgetPlayListPlayStateMessage.const_709,RoomWidgetPlayListUserActionMessage.const_966];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_914:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_828,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_950:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_849:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_709:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_966:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_269);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_269:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_967,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_948,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_980));
               break;
            case PlayListStatusEvent.const_107:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_107));
               break;
            case PlayListStatusEvent.const_144:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_144));
               break;
            case NowPlayingEvent.const_101:
               _loc2_ = param1 as NowPlayingEvent;
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorNowPlayingEvent(RoomWidgetPlayListEditorNowPlayingEvent.const_101,_loc2_.id,_loc2_.position,_loc2_.priority));
               break;
