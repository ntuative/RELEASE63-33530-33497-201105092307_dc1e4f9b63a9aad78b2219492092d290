package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1189;
         if(this.var_1189 < this.var_967.length)
         {
            _loc1_ = this.var_967[this.var_1189] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(this._window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",this.var_967.length);
                  _loc2_.text = _loc6_;
               }
            ...
            if(_loc2_)
            {
               ...
               while(_loc3_ < _loc2_.numListItems)
               {
                  ...
                  if(_loc4_)
                  {
                     ...
                     if(_loc5_)
                     {
                        if(_loc5_.testStateFlag(WindowState.const_53))
                        {
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_438)
         {
            ...
            this.var_438 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_438.center();
            this.var_438.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_967[this.var_1189] as Dictionary;
