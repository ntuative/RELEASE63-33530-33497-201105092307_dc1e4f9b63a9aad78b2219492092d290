package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_685:DimmerViewColorGrid;
      
      private var var_466:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_77,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1483,const_1484,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_685 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_466 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1581 = _loc2_.light;
         if(this.var_466 != null)
         {
            this.var_466.setValue(this.var_1581);
         }
         this.var_530 = this.colors.indexOf(_loc2_.color);
         if(this.var_685 != null)
         {
            this.var_685.setSelectedColorIndex(this.var_530);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1580 = XML(_loc1_.content);
         return this.var_1580;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_466 != null)
         {
            this.var_466.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_685 != null)
         {
            this.var_685.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
