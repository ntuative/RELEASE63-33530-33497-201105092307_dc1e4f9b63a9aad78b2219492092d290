package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_1006:String = "Boy";
      
      private static const const_1005:String = "Girl";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_1169,this.onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_430,this.onUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_1169,this.onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_430,this.onUpdate);
      }
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_385:
               ...
               break;
            case RoomWidgetClothingChangeUpdateEvent.const_430:
               this.hideEditorInterface();
         }
      }
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         this.var_2224 = param1.objectCategory;
         ...
         this._window = windowManager.createWindow("clothing change gender selection","",HabboWindowType.const_77,HabboWindowStyle.const_46,0 | 0 | 0 | 0,new Rectangle(100,100,200,200),null,0) as IWindowContainer;
      ...
      private function hideEditorInterface() : void
      {
         ...
         {
            _loc1_ = this.var_721 as IFrameWindow;
            if(_loc1_ != null)
            {
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         _loc5_.setParamFlag(HabboWindowParam.const_218,true);
         this.var_721 = _loc4_;
         this.var_721.offset(100,100);
         var _loc6_:IWindow = this.var_721.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = this.onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_414,param1,this.var_194,this.var_2224,this._roomId,this._roomCategory,_loc5_);
