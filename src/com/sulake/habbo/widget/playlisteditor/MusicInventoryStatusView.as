package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_860:String = "MISV_BUY_MORE";
      
      public static const const_893:String = "MISV_PREVIEW_PLAYING";
      ...
      private var var_1877:ITextWindow;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_457.getValues())
         {
            _loc1_.destroy();
         }
         this.var_457 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_457[param1] as IWindowContainer,0);
         this.var_44 = param1;
      }
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_1877.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_893,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_860,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_457.add(const_893,_loc1_);
            this.var_1876 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1877 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_602));
         ...
         if(_loc1_ != null)
         {
            this.var_457.add(const_860,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_563));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_457[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
