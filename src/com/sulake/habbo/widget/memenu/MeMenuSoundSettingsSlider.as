package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1221:MeMenuSoundSettingsView;
      ...
      public function set min(param1:Number) : void
      {
         ...
         this.setValue(this.var_1221.volume);
      }
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1221.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_706 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_706.width,this.var_706.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_706,this.var_706.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_705 != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_705.width,this.var_705.height,true,16777215);
                  _loc3_.bitmap.copyPixels(this.var_705,this.var_705.rect,new Point(0,0),null,null,true);
                  _loc2_.procedure = this.buttonProcedure;
                  this.var_1613 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
