package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      public function refresh(param1:String) : void
      {
         ...
         this.var_175.width = this._friendList.tabs.tabContentWidth;
         this.var_175.findChildByName("bg").width = this._friendList.tabs.tabContentWidth;
         var _loc2_:int = 1;
         for each(_loc3_ in this._friendList.tabs.getTabs())
         {
            _loc4_ = this.var_175.getChildByName("flt_" + _loc3_.id) as IWindowContainer;
         ...
         this.var_175.height = _loc2_ + 1;
         this.var_175.findChildByName("bg").height = this.var_175.height;
      ...
      private function refreshHeader(param1:FriendListTab, param2:IWindowContainer) : int
      {
         ...
         var _loc4_:Boolean = param1.id == FriendListTab.const_102 && !param1.newMessageArrived;
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this._friendList.trackFriendListEvent(HabboFriendListTrackingEvent.const_427);
         }
      }
