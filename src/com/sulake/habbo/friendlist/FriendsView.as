package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2122:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2487:IContainerButtonWindow;
      
      private var var_2484:IContainerButtonWindow;
      
      private var var_2486:IContainerButtonWindow;
      
      private var var_2485:IContainerButtonWindow;
      
      private var _list:IItemListWindow;
      
      private var var_638:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_638 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2487 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2484 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2486 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2485 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      {
         this._friendList.tabs.findTab(FriendListTab.const_102).setNewMessageArrived(true);
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = this._list.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_102,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      {
         return this._friendList.laf.getRowShadingColor(FriendListTab.const_102,param1);
      }
      
      private function refreshButtons() : void
      {
         var _loc1_:Array = this._friendList.categories.getSelectedFriends();
         this.setEnabled(this.var_2487,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2484,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2486,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2485,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_638.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_638.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_638.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_169)
         {
            _loc4_ = this._friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            this.refreshButtons();
            this.refreshList();
            if(param1.type == WindowMouseEvent.const_169 && _loc4_.online)
            {
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_102,param4);
         _loc6_.visible = true;
      }
