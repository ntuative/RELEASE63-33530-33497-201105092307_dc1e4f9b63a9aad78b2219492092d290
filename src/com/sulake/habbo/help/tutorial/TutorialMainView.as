      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_looks":
               switch(param1.type)
               {
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
                     this.var_33.showView(TutorialUI.const_408);
                     break;
            ...
            case "button_name":
               ...
               {
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
                     this.var_33.showView(TutorialUI.const_337);
                     break;
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                     this.setButtonStateOver(param2);
                     break;
            ...
            case "button_guidebot":
               ...
               {
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
                     this.var_33.showView(TutorialUI.const_624);
                     break;
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                     this.setButtonStateOver(param2);
                     break;
