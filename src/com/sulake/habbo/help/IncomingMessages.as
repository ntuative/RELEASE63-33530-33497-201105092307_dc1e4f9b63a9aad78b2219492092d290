package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onCallForHelpReply(param1:IMessageEvent) : void
      {
         ...
         this.var_21.showCallForHelpReply(_loc2_.message);
      }
      ...
      private function onRoomEntryInfo(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_21.enableCallForGuideBotUI();
         }
         else
         {
            this.var_21.disableCallForGuideBotUI();
         }
      }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         this.var_21.userRegistry.registerRoom(this.var_21.localization.getKey(_loc3_));
      }
      ...
      private function onGuestRoomResult(param1:IMessageEvent) : void
      {
         ...
         this.var_21.userRegistry.registerRoom(_loc2_.data.roomName);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_21.ownUserName = _loc2_.name;
      }
      ...
      private function onUserNameChange(param1:IMessageEvent) : void
      {
         ...
         this.var_21.ownUserName = _loc2_.newName;
         if(this.var_21.tutorialUI)
         {
            this.var_21.tutorialUI.onUserNameChanged(_loc2_.newName);
         }
         if(this.var_21.hotelMergeUI)
         {
            this.var_21.hotelMergeUI.onUserNameChanged(_loc2_.newName);
         }
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(this.var_2432 != _loc2_.id)
         {
            return;
         }
         if(this.var_21 == null || this.var_21.tutorialUI == null)
         {
            return;
         }
         this.var_21.tutorialUI.onUserChanged();
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != this._userId && _loc5_.userType == RoomObjectTypeEnum.const_147)
            {
               this.var_21.userRegistry.registerUser(_loc5_.webID,_loc5_.name);
            }
            if(_loc5_.webID == this._userId)
            {
               this.var_2432 = _loc5_.id;
            }
            _loc4_++;
         }
         this.var_21.tellUI(HabboHelpViewEnum.const_790);
      }
      ...
      private function onIssueClose(param1:IMessageEvent) : void
      {
         ...
         this.var_21.windowManager.alert("${mod.alert.title}","${help.cfh.closed." + this.getCloseReasonKey(_loc3_.closeReason) + "}",0,this.onAlertClose);
      }
      ...
      private function onCallForHelpResult(param1:IMessageEvent) : void
      {
         ...
         this.var_21.showCallForHelpResult(_loc4_);
      }
      
      private function onPendingCallsForHelpDeleted(param1:IMessageEvent) : void
      {
         this.var_21.showUI(HabboHelpViewEnum.const_381);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:FaqIndex = this.var_21.getFaq();
         ...
         this.var_21.tellUI(HabboHelpViewEnum.const_200);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this.var_21.showUI(HabboHelpViewEnum.const_574);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         this.var_21.tellUI(HabboHelpViewEnum.const_322,_loc6_);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this.var_21.tellUI(HabboHelpViewEnum.const_274,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this.var_21.showUI(HabboHelpViewEnum.const_1251);
         this.var_21.tellUI(HabboHelpViewEnum.const_1251,_loc5_);
      }
      ...
      private function onTutorialStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_21.updateTutorial(_loc2_.hasChangedLooks,_loc2_.hasChangedName,_loc2_.hasCalledGuideBot);
      }
      ...
      private function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(this.var_21.tutorialUI)
         {
            this.var_21.tutorialUI.onChangeUserNameResult(param1);
         }
         if(this.var_21.hotelMergeUI)
         {
            this.var_21.hotelMergeUI.onChangeUserNameResult(param1);
         }
      }
      ...
      private function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(this.var_21.tutorialUI)
         {
            this.var_21.tutorialUI.onCheckUserNameResult(param1);
         }
         if(this.var_21.hotelMergeUI)
         {
            this.var_21.hotelMergeUI.onCheckUserNameResult(param1);
         }
      }
