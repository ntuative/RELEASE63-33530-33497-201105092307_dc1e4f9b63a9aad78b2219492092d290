package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_429:RoomInfoViewCtrl;
      
      private var var_1159:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_450:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2967:Dictionary;
      
      private var _incomingMessages:IncomingMessages;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_2411:Array;
      
      private var var_2412:RoomThumbnailRenderer;
      
      private var var_1057:GuestRoomPasswordInput;
      
      private var var_291:GuestRoomDoorbell;
      
      private var var_1160:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2411 = new Array();
         ...
         this.var_429 = new RoomInfoViewCtrl(this);
         this.var_1159 = new RoomCreateViewCtrl(this);
         this.var_2412 = new RoomThumbnailRenderer(this);
         this.var_1057 = new GuestRoomPasswordInput(this);
         this.var_291 = new GuestRoomDoorbell(this);
         this.var_450 = new Tabs(this);
         this.var_1160 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_347,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_429.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_165,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_165,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_36)
         {
            ...
            {
               this.var_429.handleToolbarEvent(param1);
            }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_62,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_182.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_299.startSearch(Tabs.const_271,Tabs.const_447,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_299.startSearch(Tabs.const_359,Tabs.const_251);
         this.var_450.getTab(Tabs.const_359).tabPageDecorator.tabSelected();
      }
