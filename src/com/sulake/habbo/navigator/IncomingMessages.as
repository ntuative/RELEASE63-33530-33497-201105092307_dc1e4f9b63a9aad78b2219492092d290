package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1122)
         {
            this._navigator.data.eventMod = true;
         }
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1741)
         {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            {
               this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_165,HabboToolbarIconEnum.ROOMINFO));
            }
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_217 && this._navigator.sessionData.userName != _loc2_.data.ownerName)
            {
               this._navigator.doorbell.show(_loc2_.data);
            }
            else if(_loc2_.data.doorMode == RoomSettingsData.const_124 && this._navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.EXITROOM);
         ...
         {
            _loc1_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_207,HabboToolbarIconEnum.EXITROOM);
         }
      ...
      private function onFlatCreated(param1:IMessageEvent) : void
      {
         ...
         this._navigator.mainViewCtrl.reloadRoomList(Tabs.const_251);
      }
      ...
      private function onUserFlatCats(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:RoomsTabPageDecorator = RoomsTabPageDecorator(this._navigator.tabs.getTab(Tabs.const_242).tabPageDecorator);
      ...
      private function onDoorbell(param1:IMessageEvent) : void
      {
         ...
         this._navigator.doorbell.method_9();
      }
