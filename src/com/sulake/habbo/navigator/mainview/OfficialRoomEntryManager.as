package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements IDisposable
   {
      ...
      private static const const_1451:int = 267;
      
      private static const const_1449:int = 65;
      
      private static const const_1450:int = -70;
      ...
      private var var_2548:PublicRoomThumbs;
      
      public function OfficialRoomEntryManager(param1:HabboNavigator)
      {
         this.var_2548 = new PublicRoomThumbs();
         super();
      ...
      public function refreshEntry(param1:IWindowContainer, param2:Boolean, param3:int, param4:OfficialRoomEntryData) : void
      {
         ...
         if(param2)
         {
            ...
            if(param4.type == OfficialRoomEntryData.const_1742)
            {
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_939 || param2.type == OfficialRoomEntryData.const_749))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1449) : int(const_1451);
      ...
      {
         var _loc4_:String = this.var_2548.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1450) : 0;
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         if(_loc2_.guestRoomData != null)
         {
            ...
            if(_loc2_.guestRoomData.doorMode == RoomSettingsFlatInfo.const_124)
            {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_271,Tabs.const_447,_loc2_.tag);
         }
