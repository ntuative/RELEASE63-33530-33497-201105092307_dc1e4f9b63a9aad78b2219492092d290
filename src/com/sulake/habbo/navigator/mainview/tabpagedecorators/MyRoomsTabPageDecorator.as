package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2974:IWindowContainer;
      
      private var var_534:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_534 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_534.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_534 == null ? 0 : int(this.var_534.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         this._navigator.mainViewCtrl.startSearch(Tabs.const_359,this.getSearchTypeForIndex(_loc1_));
      }
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_942;
         }
         if(param1 == 2)
         {
            return Tabs.const_843;
         }
         if(param1 == 3)
         {
            return Tabs.const_853;
         }
         if(param1 == 4)
         {
            return Tabs.const_915;
         }
         return Tabs.const_251;
      }
   }
}
