package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1913:IButtonWindow;
      
      private var var_1912:IButtonWindow;
      
      private var var_2650:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1911 = IButtonWindow(this.find("bg_tab"));
         this.var_1913 = IButtonWindow(this.find("top_tab"));
         this.var_1912 = IButtonWindow(this.find("obj_tab"));
         this.var_2650 = IWindowContainer(this.find("tile_grid"));
         this.var_2649 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1911,this.onBgTabButton);
         Util.setProcDirectly(this.var_1913,this.onTopTabButton);
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_65.mode = ThumbnailEditorModel.const_38;
         this.reload();
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_65.mode = ThumbnailEditorModel.const_63;
         this.reload();
      }
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_65.mode = ThumbnailEditorModel.const_37;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1911,this.var_65.mode != ThumbnailEditorModel.const_38);
         this.setEnabled(this.var_1913,this.var_65.mode != ThumbnailEditorModel.const_63);
         this.setEnabled(this.var_1912,this.var_65.mode != ThumbnailEditorModel.const_37);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2649;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_65.mode == ThumbnailEditorModel.const_38);
         this.refreshEditImg(_loc1_,"edit_top",this.var_65.mode == ThumbnailEditorModel.const_63);
         this.refreshEditImg(_loc1_,"edit_obj",this.var_65.mode == ThumbnailEditorModel.const_37,false);
         if(this.var_65.mode == ThumbnailEditorModel.const_37)
         {
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2650;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_473)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_77,HabboWindowStyle.const_30,HabboWindowParam.const_64,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_528,HabboWindowStyle.const_46,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_347,HabboWindowStyle.const_46,HabboWindowParam.const_64,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
