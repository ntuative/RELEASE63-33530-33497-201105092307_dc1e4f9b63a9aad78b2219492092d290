package com.sulake.habbo.roomevents.userdefinedroomevents.triggerconfs
{
   ...
   public class AvatarEntersRoom implements TriggerConf
   {
      ...
      {
         return TriggerConfCodes.var_2110;
      }
      ...
      {
         this._cont = param1;
         this.getCertainAvatarRadio().addEventListener(WindowEvent.const_353,this.onCertainAvatarSelect);
         this.getCertainAvatarRadio().addEventListener(WindowEvent.const_500,this.onCertainAvatarUnselect);
      }
