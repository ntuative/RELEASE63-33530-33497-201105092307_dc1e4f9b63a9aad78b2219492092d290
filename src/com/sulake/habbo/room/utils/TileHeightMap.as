package com.sulake.habbo.room.utils
{
   public class TileHeightMap
   {
      ...
      {
         var _loc3_:* = null;
         if(param1 >= 0 && param1 < this.var_153 && param2 >= 0 && param2 < this.var_154)
         {
      ...
      public function getTileBlocking(param1:int, param2:int) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.var_153 && param2 >= 0 && param2 < this.var_154)
         {
            _loc3_ = this.var_881[param2] as Array;
      ...
      public function setTileBlocking(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(param1 >= 0 && param1 < this.var_153 && param2 >= 0 && param2 < this.var_154)
         {
            _loc4_ = this.var_881[param2] as Array;
            _loc4_[param1] = param3;
         }
      }
      ...
      public function isRoomTile(param1:int, param2:int) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.var_153 && param2 >= 0 && param2 < this.var_154)
         {
            _loc3_ = this.var_1096[param2] as Array;
            return Boolean(_loc3_[param1]);
         }
         return true;
      }
      ...
      public function setIsRoomTile(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(param1 >= 0 && param1 < this.var_153 && param2 >= 0 && param2 < this.var_154)
         {
            _loc4_ = this.var_1096[param2] as Array;
            _loc4_[param1] = param3;
            if(!param3)
            {
      ...
      public function validateLocation(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:int) : Boolean
      {
         ...
         if(param3 > this.var_153)
         {
            return false;
         }
         if(param4 > this.var_154)
         {
            return false;
         }
         if(param1 + param3 > this.var_153 || param2 + param4 > this.var_154)
         {
            return false;
         }
         if(param5 < 0 || param5 >= this.var_153)
         {
            param5 = 0;
         }
         if(param6 < 0 || param6 >= this.var_154)
         {
            param6 = 0;
         }
         if(param7 > this.var_153)
         {
            param7 = this.var_153;
         }
         if(param8 > this.var_154)
         {
            param8 = this.var_154;
         }
         if(param5 + param7 >= this.var_153)
         {
            param7 = this.var_153 - param5;
         }
         if(param6 + param8 >= this.var_154)
         {
            param8 = this.var_154 - param6;
         }
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc11_:* = null;
         ...
         {
            _loc11_ = this.var_881[_loc10_] as Array;
            _loc9_ = param1;
