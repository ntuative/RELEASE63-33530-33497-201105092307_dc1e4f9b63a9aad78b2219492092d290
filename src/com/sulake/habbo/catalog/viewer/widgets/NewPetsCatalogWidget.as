package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1424:int = 18;
      ...
      private var var_207:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_517 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_517 < 8)
         {
            return false;
         }
         this.var_2471 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_207 != null && this.var_207.length > 0)
         {
            this.var_358 = this.var_207[0];
         }
         else
         {
            this.var_358 = -1;
         }
         this._offers.add(this.var_517,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_207 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1424 && _loc2_ < this.var_207.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_517,this.var_207[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_207 != null && this.var_207.length > 0)
         {
            if(param1 < 0 || param1 > this.var_207.length)
            {
               param1 = 0;
            }
            this.var_358 = this.var_207[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_517,this.var_358),this.getRaceLocalizationKey(this.var_517,this.var_358));
            }
         }
         return this.getRaceLocalizationKey(this.var_517,this.var_358);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_358 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_517;
         var _loc3_:int = this.var_358;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_358 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
