package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private const const_228:int = 31;
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc5_)
         {
            ...
            _loc2_ = _loc7_ >= this.const_228 ? "catalog.club_gift.past_club.long" : "catalog.club_gift.past_club";
            _loc3_ = _loc7_ % this.const_228;
            _loc4_ = _loc7_ / this.const_228;
         ...
         if(_loc6_)
         {
            _loc2_ = this._controller.purse.pastVipDays >= this.const_228 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this._controller.purse.pastVipDays % this.const_228;
            _loc4_ = this._controller.purse.pastVipDays / this.const_228;
            this._controller.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this._controller.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         if(!param2.isSelectable && _loc6_ > 0)
         {
            ...
            if(_loc6_ >= this.const_228)
            {
               _loc7_ += ".long";
            }
            _loc12_ = _loc6_ % this.const_228;
            _loc13_ = _loc6_ / this.const_228;
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_226)
         {
            this.var_226 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_226)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = this.var_226.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         this.var_226.setGlobalPosition(_loc6_.subtract(new Point(this.var_226.width / 2,this.var_226.height / 2)));
