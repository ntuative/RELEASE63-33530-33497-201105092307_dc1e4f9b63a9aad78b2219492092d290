package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_82,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_827);
         _loc2_.refreshViews();
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         this._inventory.toggleInventorySubPage(InventorySubCategory.const_339);
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_163);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_436);
      ...
      {
         var _loc2_:* = null;
         if(this._inventory.isInventoryCategoryInit(InventoryCategory.const_436))
         {
      ...
      private function onUnseenItems(param1:UnseenItemsEvent) : void
      {
         ...
         this._inventory.furniModel.addUnseenFloorItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_794));
         this._inventory.furniModel.addUnseenWallItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_774));
