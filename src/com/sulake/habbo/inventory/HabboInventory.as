package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2202:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         {
            this._roomSessionManager.events.removeEventListener(RoomSessionEvent.const_90,this.roomSessionEventHandler);
            this._roomSessionManager.events.removeEventListener(RoomSessionEvent.const_98,this.roomSessionEventHandler);
            this._roomSessionManager.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_519,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_50.getValue(InventoryCategory.const_82));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_50.getValue(InventorySubCategory.const_339));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_50.getValue(InventoryCategory.const_827));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_50.getValue(InventoryCategory.const_356));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_50.getValue(InventoryCategory.ACHIEVEMENTS));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_50.getValue(InventoryCategory.const_163));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_50.getValue(InventoryCategory.const_436) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomSessionManager.events.addEventListener(RoomSessionEvent.const_90,this.roomSessionEventHandler);
         this._roomSessionManager.events.addEventListener(RoomSessionEvent.const_98,this.roomSessionEventHandler);
         this._roomSessionManager.events.addEventListener(RoomSessionPropertyUpdateEvent.const_519,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_98:
               this.var_1210 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_519:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_370 || !this._config || !this._catalog || !this._avatarRenderer || !this._roomSessionManager || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_50.add(InventoryCategory.const_436,_loc1_);
         ...
         this.var_50.add(InventoryCategory.const_827,_loc4_);
         ...
         this.var_50.add(InventoryCategory.ACHIEVEMENTS,_loc5_);
         ...
         this.var_50.add(InventorySubCategory.const_339,_loc6_);
         ...
         this.var_50.add(InventoryCategory.const_163,_loc8_);
         this.var_192 = true;
         if(this.var_2766)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_339:
               this._view.toggleCategoryView(InventoryCategory.const_82,false);
         }
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1037.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_1037.indexOf(param1);
            if(_loc3_ >= 0)
            {
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2202);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_687));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2765)
         {
            this.var_2765 = _loc1_;
