package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2173:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_370 = param5;
         this.var_370.events.addEventListener(BadgeImageReadyEvent.const_115,this.onBadgeImageReady);
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_889.length)
         {
            if(this.var_889[_loc2_] == param1)
            {
               this.var_889.splice(_loc2_,1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = this.var_245[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < this.var_245.length)
               {
                  if((this.var_245[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(this.var_245[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
