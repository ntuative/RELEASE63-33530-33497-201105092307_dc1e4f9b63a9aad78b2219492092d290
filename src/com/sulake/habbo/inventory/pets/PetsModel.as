package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_163 && this._controller.isVisible)
         {
      ...
      public function switchToFurnitureCategory(param1:String, param2:Boolean = false) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this._controller.toggleInventoryPage(InventoryCategory.const_82,param2);
         }
      }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_1621 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_33,RoomObjectTypeEnum.const_223,_loc3_.figureString);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1621 && param1.type == RoomEngineObjectEvent.const_181)
         {
