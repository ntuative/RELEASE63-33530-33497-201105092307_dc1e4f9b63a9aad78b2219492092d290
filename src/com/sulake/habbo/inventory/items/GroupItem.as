package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1514:int = 8947848;
      
      private static const const_1511:int = 13421772;
      
      private static const const_1512:int = 5466933;
      
      private static const const_1513:int = 10275685;
      ...
      protected var var_864:int = 0;
      
      protected var var_702:BitmapData;
      
      protected var var_2835:int;
      
      protected var var_1607:Boolean;
      
      protected var var_2137:Boolean;
      
      protected var var_2914:BitmapData;
      
      private var var_1535:Boolean;
      
      private const const_1935:Number = 1;
      
      private const const_1936:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2913 == FurniModel.const_44)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1499));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2136);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_852)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1936;
               _loc1_.blend = this.const_1936;
            }
            else
            {
               this._window.blend = this.const_1935;
               _loc1_.blend = this.const_1935;
            }
         }
         if(this.isSelected)
         {
            this.var_1503.color = !!this.var_1535 ? uint(const_1512) : uint(const_1514);
         }
         else
         {
            this.var_1503.color = !!this.var_1535 ? uint(const_1513) : uint(const_1511);
         }
         ...
         if(_loc5_)
         {
            if(this.var_2137 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2914;
               _loc5_.visible = true;
            }
            else
            {
