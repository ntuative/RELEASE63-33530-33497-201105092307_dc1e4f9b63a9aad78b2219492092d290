package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_156:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_493:UserInfoCtrl;
      
      private var var_1113:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_156.getHighestPriorityIssue();
         this.var_493 = new UserInfoCtrl(this._window,this.var_61,_loc3_.message);
         this.var_1113 = new UserInfoCtrl(this._window,this.var_61,_loc3_.message);
         this.var_493.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1113.load(_loc4_,this.var_156.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_156.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_156.issues;
         var _loc3_:int = 0;
         var _loc5_:int = _loc1_.numListItems;
         var _loc6_:int = _loc2_.length;
         if(_loc5_ < _loc6_)
         {
            _loc9_ = this.var_61.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset;
            if(_loc9_ == null || _loc9_.content == null)
            {
               return;
            }
            _loc4_ = this.var_61.windowManager.buildFromXML(_loc9_.content as XML) as IWindowContainer;
            if(_loc4_ == null)
            {
               return;
            }
      ...
      private function updateMessages() : void
      {
         ...
         if(_loc5_ < _loc6_)
         {
            _loc8_ = this.var_61.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset;
            if(_loc8_ == null || _loc8_.content == null)
            {
               return;
            }
            _loc4_ = this.var_61.windowManager.buildFromXML(_loc8_.content as XML) as ITextWindow;
            if(_loc4_ == null)
            {
               return;
            }
      ...
      {
         if(this.var_61 != null && this.var_61.issueManager != null && this.var_156 != null)
         {
            this.var_61.issueManager.removeHandler(this.var_156.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.closeBundle(this.var_156.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.closeBundle(this.var_156.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.closeBundle(this.var_156.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.releaseBundle(this.var_156.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_156.getHighestPriorityIssue().issueId;
         this.var_61.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_61,WindowTracker.const_1281,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_156.getHighestPriorityIssue();
            this.var_493 = new UserInfoCtrl(this._window,this.var_61,_loc3_.message);
            this.var_493.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
